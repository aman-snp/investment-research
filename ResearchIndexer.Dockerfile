...
#FROM 524234064850.dkr.ecr.us-east-1.amazonaws.com/datapipeline-core:pipeline-base-rhel-ubi8-1099627 as pipeline-base-image
FROM 524234064850.dkr.ecr.us-east-1.amazonaws.com/datapipeline-core:pipeline-base-rhel-ubi8-prod-3399695  as pipeline-base-image
#FROM 111588580784.dkr.ecr.us-east-1.amazonaws.com/datapipeline-core:pipeline-base-rhel-ubi8-1205929  as pipeline-base-image
#FROM  111588580784.dkr.ecr.us-east-1.amazonaws.com/datapipeline-core:pipeline-base-rhel-ubi8-1056437 as pipeline-base-image
...
ENV CAPITALIQ_CONFIGURATION "/capitalIQ/configuration/configUrl.dev_aws_ciq.xml"
